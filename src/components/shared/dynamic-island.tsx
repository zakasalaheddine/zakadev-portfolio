...
export default function DynamicIsland() {
	return (
		<div className="fixed left-1/2 top-6 z-[9001] flex flex-col items-center justify-start gap-6 h-13 p-3 overflow-hidden rounded-[20px] shadow-[0_0_0_1px_rgba(41,41,41,0.64)] bg-gradient-to-r from-[#292929] to-[#313131] transition-[height] duration-500  -translate-x-1/2">
			<div className="flex items-start flex-1 gap-6 justify-between">
				<Link to="/" className="flex items-center gap-2">
					<div className="flex items-center justify-center h-7 w-7 ">
						<img
							src="https://matthieurenaut.com/wp-content/themes/matthieurenaut-2025/assets/img/avatar.jpg"
							alt="logo"
				...
				<div className="flex items-center gap-2">
					...
					<Link to="/templates" className={ButtonLinkClassName}>
						<Icons.FileText className="size-4" />
					</Link>
					<Link to="/ai-automations" className={ButtonLinkClassName}>
						<Icons.Zap className="size-4" />
					</Link>
					<a href="mailto:zakasalaheddine@gmail.com" className={ButtonLinkClassName}>
